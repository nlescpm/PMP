...
\begin{table}[!h]
\begin{booktabs}{colspec={|>{\bfseries}p{0.15\textwidth}|p{0.15\textwidth}|p{\myhcolw}|p{0.15\textwidth}|p{0.15\textwidth}|},row{even}={white}}
\toprule
\textbf{What} & \textbf{Responsibility of} & \textbf{Responsible for}  & \textbf{URL} & \textbf{Additional info}\\[2ex]\toprule
\SetCell[r=2]{m,1.5cm} Zenodo (NLeSC community) & PM  & curating and approving new publications &
\SetCell[r=2]{m,1.5cm} \url{https://zenodo.org/communities/nlesc/}{Zenodo link} & 
\SetCell[r=2]{m,1.5cm} 
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
...
articles, presentations, etc.) &  & \\[2ex]\midrule
    \SetCell[r=2]{m,1.5cm} Research Software Directory (RSD), software and project pages & Lead RSE & 
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage}  & 
    \SetCell[r=2]{m,1.5cm} See See \url{https://research-software-directory.github.io/documentation/introduction.html} and
\url{https://github.com/research-software-directory/documentation/blob/main/docs/adding-projects.md} &
  \SetCell[r=2]{m,1.5cm} Each project has its RSD project page\\[2ex]\midrule 
    & RSEs &  
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage} &  & \\[2ex]\midrule
     \SetCell[r=3]{m,1.5cm} Project portfolio (on SharePoint) & PM & adding direct link to the project portfolio folder to Ganttic & 
     \SetCell[r=3]{m,1.5cm} cf.~\cite{proj-portfolio} and Appendix~\ref{app:folders} for structure explanation. &  
     \SetCell[r=3]{m,1.5cm}   
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em    
    ...
    \end{itemize} 
    \end{minipage}  \\[2ex]\midrule
   \SetCell[r=3]{m,1.5cm}  & Lead RSE & ensuring that the output is uploaded & \SetCell[r=3]{m,1.5cm} & \SetCell[r=3]{m,1.5cm} \\[2ex]\midrule
   \SetCell[r=3]{m,1.5cm}  & RSE & 
   \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage} & 
   \SetCell[r=3]{m,1.5cm} & \SetCell[r=3]{m,1.5cm} \\[2ex]\midrule
  \SetCell[r=2]{m,1.5cm} The eScience Center blog  & RSEs &  
  \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
        \item Creating blog entry regarding project, its progress or project output
    \end{itemize} 
    \end{minipage} &
  \SetCell[r=2]{m,1.5cm} Indexed at \url{https://blog.esciencecenter.nl/}{eScience Blog}, instructions on blogging are posted on the Intranet~\cite{blog-intranet}. &  
  \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage} & &   \SetCell[r=2]{m,1.5cm} \\                    
    \bottomrule
\end{booktabs}
\end{table}
