...
\let\myhcolw\relax 
\newlength{\myhcolw}
\setlength{\myhcolw}{0.3\textwidth}
\newlength{\mycolonew}
\setlength{\mycolonew}{0.12\textwidth}
\newlength{\mycolfourw}
\setlength{\mycolfourw}{0.15\textwidth}
\newlength{\mycolfivew}
\setlength{\mycolfivew}{0.2\textwidth}
\begin{table}[!h]
\setlist[itemize]{leftmargin=*}
\begin{booktabs}{colspec={|>{\bfseries}p{\mycolonew}|p{0.12\textwidth}|p{\myhcolw}|p{\mycolfourw}|p{\mycolfivew}|},row{even}={white}}
\toprule
\textbf{What} & \textbf{Responsibility of} & \textbf{Responsible for}  & \textbf{URL} & \textbf{Additional info}\\[2ex]\toprule
\SetCell[r=2]{m,\mycolonew} Zenodo (NLeSC community) & PM  & curating and approving new publications &
\SetCell[r=2]{m,\mycolfourw} \href{https://zenodo.org/communities/nlesc/}{Zenodo link} & 
\SetCell[r=2]{m,\mycolfivew} 
    \begin{minipage}[t]{\mycolfivew}
    \begin{itemize}\itemsep0em
...
articles, presentations, etc.) &  & \\[2ex]\midrule
    \SetCell[r=2]{m,\mycolonew} Research Software Directory (RSD), software and project pages & Lead RSE & 
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage}  & 
    \SetCell[r=2]{m,\mycolfourw} See \href{https://research-software-directory.github.io/documentation/introduction.html}{RSD intro} and
\href{https://github.com/research-software-directory/documentation/blob/main/docs/adding-projects.md}{Adding RSD project} &
  \SetCell[r=2]{m,\mycolfivew} Each project has its RSD project page\\[2ex]\midrule 
    & RSEs &  
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage} &  & \\[2ex]\midrule
     \SetCell[r=3]{m,\mycolonew} Project portfolio (on SharePoint) & PM & adding direct link to the project portfolio folder to Ganttic & 
     \SetCell[r=3]{m,\mycolfourw} cf.~\cite{proj-portfolio} and Appendix~\ref{app:folders} for structure explanation. &  
     \SetCell[r=3]{m,\mycolfivew}   
    \begin{minipage}[t]{\mycolfivew}
    \begin{itemize}\itemsep0em    
    ...
    \end{itemize} 
    \end{minipage}  \\[2ex]\midrule
    & Lead RSE & ensuring that the output is uploaded & & \\[2ex]\midrule
    & RSE & 
   \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
    ...
    \end{itemize} 
    \end{minipage} & &  \\[2ex]\midrule
  \SetCell[r=2]{m,\mycolonew} The eScience Center blog  & RSEs &  
  \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
        \item Creating blog entry regarding project, its progress or project output
    \end{itemize} 
    \end{minipage} &
  \SetCell[r=2]{m,\mycolfourw} Indexed at \href{https://blog.esciencecenter.nl/}{eScience Blog}, instructions on blogging are posted on the Intranet~\cite{blog-intranet}. &  
  \begin{minipage}[t]{\mycolfivew}
    \begin{itemize}\itemsep0em
...
\let\myhcolw\relax 
\let\mycolonew\relax
\let\mycolfourw\relax
\let\mycolfivew\relax
...
%  note{$\dag$} = {It is the second long long long long long long footnote.},
 ...
 % colspec = {|X|X|X|X|X|}, width = 1\linewidth,
  ...
  row{1} = {nlesc-blue}, %row{Z} = {nlesc-yellow},
  cell{2}{1,4,5} = {r=2}{c},
  cell{6}{1,4,5} = {r=3}{c},
  cell{9}{1,4} = {r=2}{c},
}
...
\midrule
Research Software Directory (RSD), software and project pages & Lead RSE & 
    \begin{minipage}[t]{1\linewidth}
    \begin{itemize}\itemsep0em
      \item creating RSD project page, if needed 
      \item maintaining RSD pages and ensuring the meta data is complete and up to date
