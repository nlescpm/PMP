...
RSD, software and project pages & PM / Lead RSE & 
  ...
  Each project has an \href{https://research-software-directory.org/organisations/netherlands-escience-center?tab=projects}{RSD page}. When reusing a project page under new funding, Lead RSE updates it with the new funding source and details.\\
\cmidrule{2-3}
    & RSEs &  
    \begin{minipage}[t]{1\linewidth}
    \begin{itemize}\itemsep0em
