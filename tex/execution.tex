...
%
\paragraph{For workshops organized by the LA:} the LA writes and submits the workshop plan(s) to the PM (cf.~\cite{proj-templates} 
...
archives);
\item acknowledge the eScience Center project grant~\footnote{By adding the following sentence into the publication: "This work was supported by the Netherlands eScience Center under grant number <grantid> - <full project title>."}; and
