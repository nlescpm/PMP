...
monitoring progress, resources, risks, and deliverables throughout the project lifecycle. This is typically the longest 
phase of an eScience project and involves close collaboration between the eScience Center project team and the LA's 
team.

The Lead RSE coordinates the day-to-day technical execution of the project, facilitating regular meetings with the 
project team and the LA, while the SH oversees the administrative aspects and supports the project whenever needed. 
Progress is continuously monitored to ensure that technical work, milestones, and reporting obligations remain aligned 
with the project objectives.

Since research projects vary considerably in scope, size, and complexity, the eScience Center does not prescribe a 
...
\begin{booktabs}{colspec={|>{\bfseries}m{0.15\textwidth}|m{0.8\textwidth}|},row{even}={gray!20}}
    ...
    Stakeholders: & PM (organizer), Lead RSE, optionally: TL\ftnotelbl{ft:tlparticipation}, other RSEs. \\
