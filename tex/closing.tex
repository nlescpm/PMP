...
including the public summary and any missing project metadata (see Appendix~\ref{app:rsd-page}), archiving the latest 
project documentation (e.g., the end report, Technology Plan, DMP and SMP, where applicable) in the project portfolio, 
and requesting revisions from the LA if necessary. Once the scientific review has been completed, the responsible SH 
approves the report and forwards it to Finance for review of the financial information. Communications may use the 
public summary and project outcomes for dissemination activities.
