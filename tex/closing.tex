...
For call projects, one month before the project end, the Lead RSE requests the LA to submit the scientific and financial end report ('Financieel en wetenschappelijk eindverslag'), providing the eScience Center template~\cite{proj-templates}.

The RSEs provide necessary information to the LA to write the end report (deliverables via the RSD project page, other relevant information as a follow-up to the project, lessons learned, etc.). 
A complete end report contains:
\begin{itemize}
\item Public summary (written in English) with clearly stated objectives/results
...
\item a list of deliverables and project outcomes missing from the RSD project page (e.g., software, papers, presentations, pitch), including list of workshops
(if applicable) 
...
\end{itemize}
For collaborative call projects, the end report written by the LA and the Lead RSE for the other funding organization (e.g., NWO) is
...
\begin{itemize}
   ...
   \item archives the end report, the lastest DMP and SMP, checklist in the respective project portfolio folder (see Appendix~\ref{app:folders}.).
\end{itemize}
...
\begin{itemize}
\item RSD: The Lead RSE updates the project page with the lay summary (from the end report), any missing meta-data (e-Infra use, keywords, deliverables, etc.) and sets the project status to 'Closed'. 
