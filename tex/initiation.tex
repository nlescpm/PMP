...
\toprule
    ...
    \begin{itemize}\itemsep0em
        ...
        \item Entering and uploading granting package documents~\ftnotelbl{ft:grantingpck}\TblrNote{a} 
  ...
  \midrule
    ...
    \begin{itemize}\itemsep0em
        ...
        \item Uploading granting package documents~\ftnotelbl{ft:grantingpck}, signed start form (Meldingsformulier start), and CA if applicable
    \end{itemize} 
    \end{minipage}  \\
  \midrule  
...
To that end, the Lead RSE should write down a technology plan for the project before executing it.
