...
The meeting is supported by an administrative kick-off presentation available in the project portfolio under the 
\textit{Templates projects} folder. The responsible SH uses this presentation to ensure that all standard topics are 
covered consistently across projects, while adapting the discussion to the specific needs of the project.
...
The presentation used during the meeting and any meeting notes are stored in the project portfolio together with the 
other project documentation.
The Secretary may assist the Section Head with scheduling the meeting and preparing the required administrative 
documentation.
