...
\begin{longtblr}[theme = fancy,
    ...
    %label = none,
   % note{b}={The image is provided by the Communications.},
...
\toprule
    ...
    \begin{itemize}\itemsep0em
        \item Creating project code, uploading grant package~\TblrNote{a} %\ftnotelbl{ft:grantingpck}. 
  ...
  \midrule  
    ...
    \begin{minipage}[t]{1\linewidth}
    \begin{itemize}\itemsep0em
        \item Creating an RSD project page (see~\cite{rsd:manual}, Appendix~\ref{app:rsd-page}). % with placeholder image\TblrNote{a}.%\ftnotelbl{ft:logo}.
