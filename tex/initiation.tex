...
\toprule
  ...
  \midrule  
    ...
    \begin{minipage}[t]{1\linewidth}
    \begin{itemize}\itemsep0em
        \item Creating an RSD project page~\cite{rsd-nlesc}, putting placeholder image with the eScience logo\footnotemark[\value{footnote}]%[1]
...
\footnotetext[1]{This image can be found in \href{https://nlesc.sharepoint.com/:f:/s/home/EkuP0l2hOI5OuQObI8zZqMgBikKDROkbSDGEn6eCFCbGsg?e=O9meCO}{this folder}.}
