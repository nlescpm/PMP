...
\label{sec:init}
The project initiation phase begins once a project has been approved for funding. Its purpose is to establish the
project within the eScience Center by completing the required administrative setup, assigning responsibilities, and
...
project types is provided in Appendix~\ref{app:internal-projects} and Appendix~\ref{app:external-projects}. Once all 
administrative, financial, and legal requirements have been completed, the project is ready to enter the execution 
phase. 
...
Each project has one assigned Section Head, who is accountable for the project throughout its lifecycle.
