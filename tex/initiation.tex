...
\begin{minipage}[t]{1\linewidth}
\begin{itemize}\itemsep0em
    \item Creating the project portfolio folder~\cite{proj-portfolio} following the required template subfolders
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The responsible SH is responsible for initially staffing the project, including the appointment of a Lead RSE and the 
assembly of the eScience Center project team~\cite{rse-teams}. Staffing decisions take into account the project’s 
requirements, available capacity, and the expertise required for successful delivery.
Once the project has started, the Lead RSE may adjust the staffing as needed (see Section~\ref{sec:exec:risks}). The 
Lead RSE will also serve as the primary point of contact for the LA.
...
section based on the organizational planning system. These considerations form the basis for assigning the eScience 
Center project team.

%%%%%%%%%%%%%%
\subsubsection{Team assignment}
%%%%%%%%%%%%%%
Every project must have one accountable Lead RSE, who is an eScience Center RSE, and at least one additional RSE or 
Engineering Doctorate (EngD) trainee assigned to the project. The eScience Center project team is assigned according to 
the following process:
\begin{enumerate}
    \item The responsible SH identifies a suitable candidate for the Lead RSE role and potential team members, taking 
    into account the staffing preparation described above.
