...
activities, responsibilities, and procedures required to manage an eScience project from project award to project 
closure.

The protocol primarily applies to projects awarded through the eScience Center calls for proposals, although it also 
provides guidance for other types of projects. It follows the project life cycle and, for each phase, specifies the 
required activities, optional activities, responsible roles, and expected outcomes.
