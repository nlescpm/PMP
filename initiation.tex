...
%\begin{longtable}[c]{|>{\bfseries}p{0.15\textwidth}|p{0.15\textwidth}|p{\myhcolw}|}
...
Project portfolio on SharePoint~\cite{proj-portfolio}  & F\&C  & 
    ...
    \end{itemize} 
    \end{minipage}  \\[2ex]\midrule
    \SetCell[r=2]{m,1.5cm} Research Software Directory (RSD), project page and software pages & PM  & 
    \begin{minipage}[t]{\myhcolw}
    \begin{itemize}\itemsep0em
