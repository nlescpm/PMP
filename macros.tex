...
%% Caption style matching the tabularray fancy theme
\DeclareCaptionLabelFormat{fancytable}{%
  \textcolor{red2}{\textbf{#1~#2:}}%
}
...
\newcommand{\LeadRSEtext}{%
  \cbox{nlesc-yellow!80!black}{Lead RSE}%
  \index{Lead RSE}%
}

\newcommand{\SHtext}{%
  \cbox{nlesc-purple!80}{SH}%
  \index{SH}%
}

\newcommand{\Financetext}{%
  \cbox{nlesc-blue!50!black}{Finance}%
  \index{Finance}%
}

% Disable automatic role highlighting

\newcommand{\disablehighlights}{%
  \UndoBoundary{LeadRSEkey}%
  \UndoBoundary{SHkey}%
  \UndoBoundary{Financekey}%
}

% Enable automatic role highlighting
