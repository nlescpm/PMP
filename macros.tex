...
%\setmainfont[Path = /usr/share/texlive/texmf-dist/fonts/opentype/public/,
%  Extension = .otf, ItalicFont = Nunito-Italic.otf]{Assistant}
%\setsansfont{Nunito}

\setmainfont[Path = font/, Extension = .ttf,UprightFont = *-Regular, BoldFont = *-Bold, ItalicFont = Nunito-LightItalic]
{Assistant}
