...
Call procedures follow a separate protocol[FFFC?]\footnote{ See
Section\ref{bkm:Ref146047739}\ for the reference link.} and are
...
The structure of this document largely follows the project life cycle (see Section \ref{bkm:Ref107312212}); the
